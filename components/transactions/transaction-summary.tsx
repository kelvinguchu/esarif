...
export const TransactionSummary = () => {
  ...
  return (
    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8'>
      <Card className='border-0 bg-[#001a38] shadow-md overflow-hidden transform transition-transform hover:translate-y-[-2px]'>
      ...
      <Card className='border-0 bg-[#001a38] shadow-md overflow-hidden transform transition-transform hover:translate-y-[-2px]'>
        ...
        <CardContent className='p-5'>
          <div className='flex items-center justify-between'>
            <div>
              <p className='text-white/70 text-sm mb-1'>Trading Volume</p>
              <p className='text-white text-2xl font-semibold'>
                ${summaryData.tradingVolume}
              </p>
              <p className='text-blue-400 text-xs mt-1'>Last 30 days</p>
            </div>
      ...
      <Card className='border-0 bg-[#001a38] shadow-md overflow-hidden transform transition-transform hover:translate-y-[-2px]'>
        ...
        <CardContent className='p-5'>
          <div className='flex items-center justify-between'>
            <div>
              <p className='text-white/70 text-sm mb-1'>Crypto Holdings</p>
              <p className='text-white text-2xl font-semibold'>
      ...
      <Card className='border-0 bg-[#001a38] shadow-md overflow-hidden transform transition-transform hover:translate-y-[-2px]'>
        ...
        <CardContent className='p-5'>
          <div className='flex items-center justify-between'>
            <div>
              <p className='text-white/70 text-sm mb-1'>Fiat Balance</p>
              <p className='text-white text-2xl font-semibold'>
